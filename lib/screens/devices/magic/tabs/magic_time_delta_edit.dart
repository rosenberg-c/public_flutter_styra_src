...
import 'package:flutter_styra/services/http/requests/backlight/backlight_get_config.dart';
import 'package:flutter_styra/services/http/requests/backlight/backlight_restart_service.dart';
import 'package:flutter_styra/services/http/requests/backlight/backlight_update_config.dart';
...
class _MagicTimeDeltaEditState extends State<MagicTimeDeltaEdit> {
  ...
  void initState() {
    ...
    getOnline(
      ...
      getBacklightConfig(widget.device).then((onValue) {
                  ...
                  children: [
                    RaisedButton(
                      ...
                      onPressed: () async {
                        ...
                        await updateBacklightConfig(
                            widget.device, _delta_config);
                        await restartBacklightService(widget.device);
                        setState(() {
                          _didUpdate = true;
                        });
